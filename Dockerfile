...
# install phosphoviper.db
ADD ./ ./
RUN R CMD INSTALL ./

# docker build -t docker.pkg.github.com/califano-lab/phosphoviper.db/phosphoviper.db:latest ./
# docker push docker.pkg.github.com/califano-lab/phosphoviper.db/phosphoviper.db:latest
